// ===== 04-DATAINTEGRATOR.GS - KOMPLETNY INTEGRATOR DANYCH =====
// ====================================
...
class UltraDataIntegrator {
  constructor(logger) {
    ...
    this.columnMapping = {
      ...
      'sales': [
        // ANGIELSKIE (dokładnie jak w logach!)
  ...
  integrateData(reports) {
    ...
    this.logger.log(`✅ Integration complete - Sales: ${integratedData.totals.sales}€, Spend: ${integratedData.totals.spend}€`, 'SUCCESS');
